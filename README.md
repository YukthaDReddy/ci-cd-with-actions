[![React App CI](https://github.com/YukthaDReddy/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/YukthaDReddy/ci-cd-with-actions/actions/workflows/ci.yml)
